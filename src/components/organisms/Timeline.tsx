...
const Timeline: FC<Props> = ({ title, subTitle, data }) => {
  return (
    <PageSection id="timeline" title={title} subTitle={subTitle}>
      <ul className="p-0 relative before:absolute before:content-none before:top-0 before:bottom-0 before:left-50% before:w-2px before:bg-gray-200 before:ml-8px">
